      ...
      {DisplayType === "Impove Content" && (
        <div className='p-2 '>
          <div className='d-flex justify-content-between'>
            <div className='w-50 shadow rounded me-2'>
            ...
            <div className='w-50 shadow rounded p-2' style={{ height: "84vh" }}>
              <div className='p-2 bg-white h-100'>
                ...
                {(currentItems.length > 0 && !error) ? (
                  ...
                  <div style={{ textAlign: "center", overflow: "hidden" }}>
                    <img  style={{ textAlign: "center" }} src={BGImage} className='conimproverbgimg' />
                  </div>
                }
                {totalPages > 1 && (
